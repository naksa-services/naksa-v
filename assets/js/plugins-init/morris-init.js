	...
	var dzMorris = function () {
		...
		var donutChart = function () {
			Morris.Donut({
				...
				resize: true,
				redraw: true,
				colors: ['#e4e632', 'rgb(255, 92, 0)', '#D8B9C3'],
				//responsive:true,
		...
		var lineChart2 = function () {
			...
			Morris.Area({
				...
				pointSize: 3,
				fillOpacity: 0,
				pointStrokeColors: ['#FF3E3E', '#D8B9C3', '#e4e632'],
				behaveLikeLine: true,
				gridLineColor: 'transparent',
				lineWidth: 3,
				hideHover: 'auto',
				lineColors: ['rgb(255, 62, 62)', 'rgb(0, 171, 197)', '#e4e632'],
				resize: true
		...
		var barChart = function () {
			if (jQuery('#morris_bar').length > 0) {
				...
				Morris.Bar({
					...
					ykeys: ['a', 'b', 'c'],
					labels: ['A', 'B', 'C'],
					barColors: ['#e4e632', '#D8B9C3', '#ff9f00'],
					hideHover: 'auto',
					gridLineColor: 'transparent',
					resize: true,
					barSizeRatio: 0.25,
		...
		var areaChart = function () {
			...
			Morris.Area({
				...
				lineColors: ['#e4e632', 'rgb(16, 202, 147)', 'rgb(255, 92, 0)'],
				xkey: 'period',
				ykeys: ['smartphone', 'windows', 'mac'],
				labels: ['Phone', 'Windows', 'Mac'],
				pointSize: 0,
